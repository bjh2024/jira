...
public class UtilityService {
	...
	public LocalDateTime localDateTimeChange(Object obj) {
		LocalDateTime result = null;
		if (obj != null && obj instanceof LocalDateTime) {
			result = objectMapper.convertValue(obj, LocalDateTime.class);
		}else if (obj != null && obj instanceof Timestamp) {
			result = objectMapper.convertValue(obj, Timestamp.class).toLocalDateTime();
		} 
		return result;
	}
